[![Build Status](https://dev.azure.com/tek10ger/tek10ger/_apis/build/status%2Fhaxkrp.python-sample-vscode-flask-tutorial?branchName=main)](https://dev.azure.com/tek10ger/tek10ger/_build/latest?definitionId=1&branchName=main)
